...
import com.jujutsu.jujutsucraftaddon.procedures.SetSimpleProcedure;
...
public class ChangeSimpleDomainLevel extends BaseCommand<Double> {

    @Override
    protected String getName () {
        return "jjkuChangeSimpleDomainLevel";
    }
    ...
    protected void execute (CommandContext<CommandSourceStack> ctx, Double value){
        SetSimpleProcedure.execute(ctx);
    }

    @SubscribeEvent
    public static void registerCommand (RegisterCommandsEvent event){
        new ChangeSimpleDomainLevel().register(event);
    }
}
