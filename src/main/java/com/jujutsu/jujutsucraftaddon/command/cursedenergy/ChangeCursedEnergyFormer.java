...
public class ChangeCursedEnergyFormer extends BaseCommand<Double> {

    @Override
    protected String getName() { return "jjkuChangeCursedEnergyFormer"; }
    ...
    protected void execute(CommandContext<CommandSourceStack> ctx, Double value) {
        ChangeCursePowerFormerBaseProcedure.execute(ctx.getSource().getUnsidedLevel(), ctx);
    }

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent event) {
        new ChangeCursedEnergyFormer().register(event);
    }
}
