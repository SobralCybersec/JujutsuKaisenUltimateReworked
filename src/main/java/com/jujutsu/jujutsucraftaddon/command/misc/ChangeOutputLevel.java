...
public class ChangeOutputLevel extends BaseCommand<Double> {

    @Override
    protected String getName() { return "jjkuChangeOutputLevel"; }
    ...
    protected void execute(CommandContext< CommandSourceStack > ctx, Double value) {
        SetOuputProcedure.execute( ctx);
    }

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent event) {
        new ChangeOutputLevel().register(event);
    }
}
