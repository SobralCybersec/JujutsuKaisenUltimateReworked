...
public class ChangeCursedLevel extends BaseCommand<Double> {

    @Override
    protected String getName () {
        return "jjkuChangeCursedLevel";
    }
    ...
    protected void execute (CommandContext< CommandSourceStack > ctx, Double value){
        CursedLevelProcedure.execute(ctx);
    }

    @SubscribeEvent
    public static void registerCommand (RegisterCommandsEvent event){
        new ChangeCursedLevel().register(event);
    }
