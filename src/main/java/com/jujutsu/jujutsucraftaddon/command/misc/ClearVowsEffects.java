...
public class ClearVowsEffects extends BaseCommand<Double> {

    @Override
    protected String getName() { return "jjkuClearVowsCD"; }
    ...
    protected void execute(CommandContext<CommandSourceStack> ctx, Double value) {
        VowClearProcedure.execute(ctx.getSource().getEntity());
    }

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent event) {
        new ClearVowsEffects().register(event);
    }
}
