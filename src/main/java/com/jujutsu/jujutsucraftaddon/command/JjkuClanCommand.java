...
public class JjkuClanCommand {
    ...
    public static void registerCommand(RegisterCommandsEvent event) {
        event.getDispatcher().register(Commands.literal("jjkuClan").requires(s -> s.hasPermission(2)).then(Commands.literal("Geto").then(Commands.argument("Player", EntityArgument.player()).executes(arguments -> {
            ...
            return 0;
        }))).then(Commands.literal("Majima").then(Commands.argument("Player", EntityArgument.player()).executes(arguments -> {
            Level world = arguments.getSource().getUnsidedLevel();
            double x = arguments.getSource().getPosition().x();
            double y = arguments.getSource().getPosition().y();
            double z = arguments.getSource().getPosition().z();
            ...
            ClanMajimaProcedure.execute(arguments);
            return 0;
        }))).then(Commands.literal("Kiryu").then(Commands.argument("Player", EntityArgument.player()).executes(arguments -> {
            Level world = arguments.getSource().getUnsidedLevel();
            double x = arguments.getSource().getPosition().x();
            double y = arguments.getSource().getPosition().y();
            double z = arguments.getSource().getPosition().z();
            ...
            ClanKiryuProcedure.execute(arguments);
            return 0;
        }))));
    }
}
