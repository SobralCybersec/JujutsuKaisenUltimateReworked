...
import com.jujutsu.jujutsucraftaddon.procedures.SukunaKeybindOnKeyPressedProcedure;
...
public class AwakeningUncontrolledSukuna extends BaseCommand<Double> {

    @Override
    protected String getName() { return "jjkuAwakeningUncontrolledSukuna"; }
    ...
    protected void execute(CommandContext<CommandSourceStack> ctx, java.lang.Double value) {
        SukunaKeybindOnKeyPressedProcedure.execute(ctx.getSource().getEntity());
    }

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent event) {
        new AwakeningUncontrolledSukuna().register(event);
    }
}
