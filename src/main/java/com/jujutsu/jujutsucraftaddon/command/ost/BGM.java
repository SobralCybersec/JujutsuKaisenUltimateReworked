package com.jujutsu.jujutsucraftaddon.command.ost;

import com.jujutsu.jujutsucraftaddon.command.setup.BaseCommand;
import com.jujutsu.jujutsucraftaddon.procedures.BGMProcedure;
...
public class BGM extends BaseCommand<Double> {
    ...
    protected void execute (CommandContext< CommandSourceStack > ctx, Double value){
        BGMProcedure.execute(ctx.getSource().getEntity());
    }

    @SubscribeEvent
    public static void registerCommand (RegisterCommandsEvent event){
        new BGM().register(event);
    }
