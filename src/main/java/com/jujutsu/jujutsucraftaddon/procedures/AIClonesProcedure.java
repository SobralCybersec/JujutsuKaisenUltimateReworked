...
public class AIClonesProcedure {
    public static void execute(LevelAccessor world, Entity entity) {
        if (entity == null || world == null)
            return;

        double tick;
        double tag = entity.getPersistentData().getDouble("Tagged");
        if (new Object() {
            ...
            if (new Object() {
                ...
                if (Math.random() >= 0.9) {
                    ...
                    if (entity instanceof CloneEntity) {
                        entity.getPersistentData().putDouble("skill", (Mth.nextInt(RandomSource.create(), 1, 50)) * 100 + (Mth.nextInt(RandomSource.create(), 1, 20)));
                    } else {
                        entity.getPersistentData().putDouble("skill", (Mth.nextInt(RandomSource.create(), -98, -96)));
                    }
                    if (new Object() {
