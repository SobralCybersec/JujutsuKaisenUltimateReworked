                ...
                if (player.isShiftKeyDown()) {
                    Minecraft.getInstance().execute(() -> {
                        if (Minecraft.getInstance().screen == null) {
                            Minecraft.getInstance().setScreen(new MasteryActiveSkillMenu());
                        }
                    });
                    ...
                    if (player.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables()).PlayerCurseTechnique2 == 5) {
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new MahitoSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new WukongSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new TodoSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new ChosoSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new MegumiSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new HeavenlyRestrictionSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new ItadoriSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new HakariSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new MahoragaSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new GojoSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new SukunaSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new KashimoSkillMenu());
                            }
                        });
                        ...
                        Minecraft.getInstance().execute(() -> {
                            if (Minecraft.getInstance().screen == null) {
                                Minecraft.getInstance().setScreen(new UraumeSkillMenu());
                            }
                        });
                    }
                }
    ...
    public static final KeyMapping KEY_WHEEL = new KeyMapping("key.jujutsucraftaddon.key_wheel", GLFW.GLFW_KEY_C, "Jujutsu Kaisen Ultimate") {
        ...
        public void setDown(boolean isDown) {
            ...
            if (isDownOld != isDown && isDown) {
                ...
                Minecraft.getInstance().execute(() -> {
                    if (Minecraft.getInstance().screen == null) {
                        Minecraft.getInstance().setScreen(new MasteryEnergyMenu());
                    }
                });
            }
            isDownOld = isDown;
