package com.jujutsu.jujutsucraftaddon.misc.renderer;
...
public class WeaponSizeManipulationRenderer extends BlockEntityWithoutLevelRenderer {
    public WeaponSizeManipulationRenderer() {
       super(null, null);
    }
