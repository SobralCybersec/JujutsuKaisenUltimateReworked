package com.jujutsu.jujutsucraftaddon.entity.sorcerer;

import com.jujutsu.jujutsucraftaddon.init.mod.JujutsucraftaddonModEntities;
import com.jujutsu.jujutsucraftaddon.procedures.AIBaseProcedure;
import com.jujutsu.jujutsucraftaddon.procedures.ItadoriShinjukuEffectsProcedure;
...
public class ItadoriShinjukuEntity extends Monster implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ItadoriShinjukuEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ItadoriShinjukuEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ItadoriShinjukuEntity.class, EntityDataSerializers.STRING);
