package com.jujutsu.jujutsucraftaddon.client.renderer.sukuna;

import com.jujutsu.jujutsucraftaddon.item.armors.SukunaCoatItem;
import com.jujutsu.jujutsucraftaddon.item.model.SukunaCoatModel;
...
public class SukunaCoatRenderer extends GeoArmorRenderer<SukunaCoatItem> {
    public SukunaCoatRenderer() {
        super(new SukunaCoatModel());
    ...
    @Override
    public RenderType getRenderType(SukunaCoatItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
