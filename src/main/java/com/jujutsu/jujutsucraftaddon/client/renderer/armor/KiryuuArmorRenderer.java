...
import com.jujutsu.jujutsucraftaddon.item.model.KiryuuArmorModel;
import com.jujutsu.jujutsucraftaddon.item.robes.KiryuuOutfitItem;
...
public class KiryuuArmorRenderer extends GeoArmorRenderer<KiryuuOutfitItem> {
    public KiryuuArmorRenderer() {
        super(new KiryuuArmorModel());
    ...
    @Override
    public RenderType getRenderType(KiryuuOutfitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
