...
public class ChosoScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<ChosoScreen.AltarOption> options = this.getOptions();
    ...
    private List<ChosoScreen.AltarOption> getOptions() {
        List<ChosoScreen.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            ChosoScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends ChosoScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends ChosoScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        ChosoScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
