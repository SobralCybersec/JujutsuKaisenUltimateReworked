...
public class BrokenBrainStatus4 extends BaseBrainStatusOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.brainStatus(
            "red",
            "gui.jujutsucraftaddon.overlay_braiin_4.label_braindamage",
    ...
    protected String getTranslationKey() {
        return "gui.jujutsucraftaddon.overlay_braiin_4.label_braindamage";
    }

    @SubscribeEvent(priority = EventPriority.NORMAL)
    public static void eventHandler(RenderGuiEvent.Pre event) {
        new BrokenBrainStatus4().render(event);
    }
}
