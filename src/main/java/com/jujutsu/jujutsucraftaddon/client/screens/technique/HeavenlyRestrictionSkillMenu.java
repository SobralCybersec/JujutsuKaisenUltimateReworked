...
public class HeavenlyRestrictionSkillMenu extends Screen {
    ...
    public HeavenlyRestrictionSkillMenu() {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<HeavenlyRestrictionSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<HeavenlyRestrictionSkillMenu.AltarOption> getOptions() {
        List<HeavenlyRestrictionSkillMenu.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            HeavenlyRestrictionSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends HeavenlyRestrictionSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends HeavenlyRestrictionSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        HeavenlyRestrictionSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
