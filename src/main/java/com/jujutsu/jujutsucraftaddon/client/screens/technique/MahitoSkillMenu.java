...
public class MahitoSkillMenu extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<MahitoSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<MahitoSkillMenu.AltarOption> getOptions() {
        List<MahitoSkillMenu.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            MahitoSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends MahitoSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends MahitoSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        MahitoSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
