...
public class ItadoriScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<ItadoriScreen.AltarOption> options = this.getOptions();
    ...
    private List<ItadoriScreen.AltarOption> getOptions() {
        List<ItadoriScreen.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            ItadoriScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends ItadoriScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends ItadoriScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        ItadoriScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
