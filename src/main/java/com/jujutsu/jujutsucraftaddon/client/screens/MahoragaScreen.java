...
public class MahoragaScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<MahoragaScreen.AltarOption> options = this.getOptions();
    ...
    private List<MahoragaScreen.AltarOption> getOptions() {
        List<MahoragaScreen.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            MahoragaScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends MahoragaScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends MahoragaScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        MahoragaScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
