package com.jujutsu.jujutsucraftaddon.client.screens.technique;
...
public class MegumiSkillMenu extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<MegumiSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<MegumiSkillMenu.AltarOption> getOptions() {
        List<MegumiSkillMenu.AltarOption> options = new ArrayList<>();
        options.add(new MegumiSkillMenu.AltarOption("Divine Dog Totality"));
        options.add(new MegumiSkillMenu.AltarOption("Nue"));
        options.add(new MegumiSkillMenu.AltarOption("Serpent"));
        options.add(new MegumiSkillMenu.AltarOption("Toad"));
        options.add(new MegumiSkillMenu.AltarOption("Max Elephant"));
        options.add(new MegumiSkillMenu.AltarOption("Rabbit Escape"));
        options.add(new MegumiSkillMenu.AltarOption("Round Deer"));
        options.add(new MegumiSkillMenu.AltarOption("Piercing Ox"));
        options.add(new MegumiSkillMenu.AltarOption("Tiger Funeral"));
        options.add(new MegumiSkillMenu.AltarOption("Agito"));
        options.add(new MegumiSkillMenu.AltarOption("MAHORAGA"));
        options.add(new MegumiSkillMenu.AltarOption("Piercing Water"));
        options.add(new MegumiSkillMenu.AltarOption("Giant Nue"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            MegumiSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends MegumiSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends MegumiSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        MegumiSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
