...
public class BrokenBrainStatus3 extends BaseBrainStatusOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.brainStatus(
            "orange",
            "gui.jujutsucraftaddon.overlay_braiin_3.label_braindamage",
    ...
    protected String getTranslationKey() {
        return "gui.jujutsucraftaddon.overlay_braiin_3.label_braindamage";
    }

    @SubscribeEvent(priority = EventPriority.NORMAL)
    public static void eventHandler(RenderGuiEvent.Pre event) {
        new BrokenBrainStatus3().render(event);
    }
}
