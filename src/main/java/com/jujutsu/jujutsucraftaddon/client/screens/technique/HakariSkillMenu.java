...
public class HakariSkillMenu extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<HakariSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<HakariSkillMenu.AltarOption> getOptions() {
        List<HakariSkillMenu.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            HakariSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends HakariSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends HakariSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        HakariSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
