...
public class MegumiScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<MegumiScreen.AltarOption> options = this.getOptions();
    ...
    private List<MegumiScreen.AltarOption> getOptions() {
        List<MegumiScreen.AltarOption> options = new ArrayList<>();
        options.add(new MegumiScreen.AltarOption("Divine Dog Totality"));
        options.add(new MegumiScreen.AltarOption("Nue"));
        options.add(new MegumiScreen.AltarOption("Serpent"));
        options.add(new MegumiScreen.AltarOption("Toad"));
        options.add(new MegumiScreen.AltarOption("Max Elephant"));
        options.add(new MegumiScreen.AltarOption("Rabbit Escape"));
        options.add(new MegumiScreen.AltarOption("Round Deer"));
        options.add(new MegumiScreen.AltarOption("Piercing Ox"));
        options.add(new MegumiScreen.AltarOption("Tiger Funeral"));
        options.add(new MegumiScreen.AltarOption("Agito"));
        options.add(new MegumiScreen.AltarOption("MAHORAGA"));
        options.add(new MegumiScreen.AltarOption("Piercing Water"));
        options.add(new MegumiScreen.AltarOption("Giant Nue"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            MegumiScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends MegumiScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends MegumiScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        MegumiScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
