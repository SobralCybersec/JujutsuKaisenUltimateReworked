...
public class HakariScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<HakariScreen.AltarOption> options = this.getOptions();
    ...
    private List<HakariScreen.AltarOption> getOptions() {
        List<HakariScreen.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            HakariScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends HakariScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends HakariScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        HakariScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
