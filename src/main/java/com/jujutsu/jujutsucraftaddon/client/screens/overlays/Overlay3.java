...
import com.jujutsu.jujutsucraftaddon.procedures.OverlayThreeDisplayOverlayIngameProcedure;
...
public class Overlay3 extends BaseOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.fullscreen(
            "kokusen3",
            "textures/screens/kokusen3.png",
            player -> OverlayThreeDisplayOverlayIngameProcedure.execute(player.level(), player)
    );
