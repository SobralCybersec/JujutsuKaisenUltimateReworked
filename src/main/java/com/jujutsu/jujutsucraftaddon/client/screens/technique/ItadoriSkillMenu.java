...
public class ItadoriSkillMenu extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<ItadoriSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<ItadoriSkillMenu.AltarOption> getOptions() {
        List<ItadoriSkillMenu.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            ItadoriSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends ItadoriSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends ItadoriSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        ItadoriSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
