...
import com.jujutsu.jujutsucraftaddon.procedures.ImpactFrameOverlayCondition8;
...
public class ImpactFrameKokusen8 extends BaseOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.fullscreen(
            "kokusen11",
            "textures/screens/kokusen11.png",
            player -> ImpactFrameOverlayCondition8.execute(player.level(), player)
    );
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        new ImpactFrameKokusen8().render(event);
    }
}
