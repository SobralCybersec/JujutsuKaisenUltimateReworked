...
public class UraumeSkillMenu extends Screen {
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            int white = toRGB24(190, 210, 255, 150);
            int black = toRGB24(138, 180, 248, 150);
            ...
            if (this.hovered > 0) {
                ...
                AltarMessageUraume.pressAction(Minecraft.getInstance().player, this.hovered);
