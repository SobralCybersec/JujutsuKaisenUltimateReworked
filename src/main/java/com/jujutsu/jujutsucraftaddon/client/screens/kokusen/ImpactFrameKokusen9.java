...
import com.jujutsu.jujutsucraftaddon.procedures.ImpactFrameOverlayCondition9;
...
public class ImpactFrameKokusen9 extends BaseOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.fullscreen(
            "kokusen12",
            "textures/screens/kokusen12.png",
            player -> ImpactFrameOverlayCondition9.execute(player.level(), player)
    );
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        new ImpactFrameKokusen9().render(event);
    }
}
