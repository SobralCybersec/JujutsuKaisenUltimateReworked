...
public class HRScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<HRScreen.AltarOption> options = this.getOptions();
    ...
    private List<HRScreen.AltarOption> getOptions() {
        List<HRScreen.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            HRScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends HRScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends HRScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        HRScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
