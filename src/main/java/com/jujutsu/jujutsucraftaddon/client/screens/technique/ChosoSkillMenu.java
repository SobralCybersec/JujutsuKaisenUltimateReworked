...
public class ChosoSkillMenu extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<ChosoSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<ChosoSkillMenu.AltarOption> getOptions() {
        List<ChosoSkillMenu.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            ChosoSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends ChosoSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends ChosoSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        ChosoSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
