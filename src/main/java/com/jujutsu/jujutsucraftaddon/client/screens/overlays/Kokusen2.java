...
import com.jujutsu.jujutsucraftaddon.procedures.OverlayZeroDoisDisplayOverlayIngameProcedure;
...
public class Kokusen2 extends BaseOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.fullscreen(
            "kokusen02",
            "textures/screens/kokusen02.png",
            player -> OverlayZeroDoisDisplayOverlayIngameProcedure.execute(player.level(), player)
    );
