...
import com.jujutsu.jujutsucraftaddon.procedures.ImpactFrameOverlayCondition7;
...
public class ImpactFrameKokusen7 extends BaseOverlay {
    private static final OverlayConfig CONFIG = OverlayConfig.fullscreen(
            "kokusen10",
            "textures/screens/kokusen10.png",
            player -> ImpactFrameOverlayCondition7.execute(player.level(), player)
    );
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        new ImpactFrameKokusen7().render(event);
    }
}