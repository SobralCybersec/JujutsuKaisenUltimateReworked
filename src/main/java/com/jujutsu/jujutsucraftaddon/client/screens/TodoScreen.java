...
public class TodoScreen extends Screen {
    ...
    private final List<List<TodoScreen.AltarOption>> pages = new ArrayList<>();
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<TodoScreen.AltarOption> options = this.getOptions();
    ...
    private List<TodoScreen.AltarOption> getOptions() {
        List<TodoScreen.AltarOption> options = new ArrayList<>();
        options.add(new TodoScreen.AltarOption("Boogie Woogie"));
        options.add(new TodoScreen.AltarOption("Quick Attack"));
        options.add(new TodoScreen.AltarOption("Swap"));
        options.add(new TodoScreen.AltarOption("Itadori"));
        options.add(new TodoScreen.AltarOption("Vibraslap"));
        options.add(new TodoScreen.AltarOption("Swap Team Attack"));
        options.add(new TodoScreen.AltarOption("Boogie Woogie Deflect"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            TodoScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends TodoScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends TodoScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        TodoScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
