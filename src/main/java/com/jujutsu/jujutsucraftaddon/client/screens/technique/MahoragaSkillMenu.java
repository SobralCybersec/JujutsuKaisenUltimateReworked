...
public class MahoragaSkillMenu extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<MahoragaSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<MahoragaSkillMenu.AltarOption> getOptions() {
        List<MahoragaSkillMenu.AltarOption> options = new ArrayList<>();
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            MahoragaSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends MahoragaSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends MahoragaSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        MahoragaSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
