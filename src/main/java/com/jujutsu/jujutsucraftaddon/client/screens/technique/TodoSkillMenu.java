...
public class TodoSkillMenu extends Screen {
    ...
    private final List<List<TodoSkillMenu.AltarOption>> pages = new ArrayList<>();
    private int hovered = -1;

    public TodoSkillMenu() {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<TodoSkillMenu.AltarOption> options = this.getOptions();
    ...
    private List<TodoSkillMenu.AltarOption> getOptions() {
        List<TodoSkillMenu.AltarOption> options = new ArrayList<>();
        options.add(new TodoSkillMenu.AltarOption("Boogie Woogie"));
        options.add(new TodoSkillMenu.AltarOption("Quick Attack"));
        options.add(new TodoSkillMenu.AltarOption("Swap"));
        options.add(new TodoSkillMenu.AltarOption("Itadori"));
        options.add(new TodoSkillMenu.AltarOption("Vibraslap"));
        options.add(new TodoSkillMenu.AltarOption("Swap Team Attack"));
        options.add(new TodoSkillMenu.AltarOption("Boogie Woogie Deflect"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            TodoSkillMenu.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends TodoSkillMenu.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends TodoSkillMenu.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        TodoSkillMenu.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
