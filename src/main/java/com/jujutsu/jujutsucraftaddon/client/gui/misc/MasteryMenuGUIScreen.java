...
import com.jujutsu.jujutsucraftaddon.network.WorldSkillButtonMessage;
...
public class MasteryMenuGUIScreen extends AbstractContainerScreen<WorldSkillMenu> {
    ...
    public MasteryMenuGUIScreen(WorldSkillMenu container, Inventory inventory, Component text) {
